                        ...
                        <div className="card-body pb-0">
                          ...
                          <div className="d-block d-xl-flex">
                            ...
                            <div className="mb-3 flex-fill">
                              ...
                              <input type="email" className="form-control" placeholder="Enter Postal Code"/>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="card-body pb-0">
                          <div className="mb-3 mb-3">
                            ...
                            <div className="pass-group d-flex">
                              <input type={passwordVisibility.currentPassword
            ? "text"
            : "password"} className="pass-input form-control"/>
                              <span className={`ti toggle-passwords ${passwordVisibility.currentPassword
            ? "ti-eye"
            : "ti-eye-off"}`} onClick={() => togglePasswordVisibility("currentPassword")}></span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" placeholder="Enter State/Province"/>
                      </div>
                      <div className="mb-3">
                        <label className="form-label">City</label>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="mb-3">
                        ...
                        <div className="pass-group d-flex">
                          <input type={passwordVisibility.oldPassword
            ? "text"
            : "password"} className="pass-input form-control"/>
                          <span className={`ti toggle-passwords ${passwordVisibility.oldPassword
            ? "ti-eye"
            : "ti-eye-off"}`} onClick={() => togglePasswordVisibility("oldPassword")}></span>
                        </div>
                      </div>
                      <div className="mb-3">
                        <label className="form-label">New Password</label>
                        <div className="pass-group d-flex">
                          <input type={passwordVisibility.newPassword
            ? "text"
            : "password"} className="pass-input form-control"/>
                          <span className={`ti toggle-passwords ${passwordVisibility.newPassword
            ? "ti-eye"
            : "ti-eye-off"}`} onClick={() => togglePasswordVisibility("newPassword")}></span>
                        </div>
                      </div>
                      <div className="mb-0">
