      ...
      <div className="card-body pb-1">
        <div className="d-block">
          <div className="d-flex align-items-center justify-content-between flex-wrap shadow-sm p-3 pb-0 noti-hover border rounded mb-3">
            <div className="d-flex align-items-start flex-fill">
              <Link to="#" className="avatar avatar-lg flex-shrink-0 me-2 mb-2">
                <ImageWithBasePath alt="Lesley Grauer" src="assets/img/profiles/avatar-01.jpg" className=" img-fluid"/>
              </Link>
              <div className="mb-3">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap shadow-sm noti-hover border p-3 pb-0 rounded mb-3">
            <div className="d-flex align-items-start flex-fill">
              <Link to="#" className="avatar avatar-lg flex-shrink-0 me-2 mb-3">
                <ImageWithBasePath alt="Lesley Grauer" src="assets/img/profiles/avatar-02.jpg" className=" img-fluid"/>
              </Link>
              <div className="mb-3">
                <p className="mb-0 text-dark  fw-medium">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap shadow-sm noti-hover border p-3 pb-0 rounded mb-3">
            <div className="d-flex align-items-start flex-fill">
              <Link to="#" className="avatar avatar-lg flex-shrink-0 me-2 mb-3">
                <ImageWithBasePath alt="Lesley Grauer" src="assets/img/profiles/avatar-04.jpg" className=" img-fluid"/>
              </Link>
              <div className="mb-3">
                <p className="mb-0 text-dark  fw-medium">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap shadow-sm noti-hover border p-3 pb-0 rounded mb-3">
            <div className="d-flex align-items-start flex-fill">
              <Link to="#" className="avatar avatar-lg flex-shrink-0 me-2 mb-3">
                <ImageWithBasePath alt="Lesley Grauer" src="assets/img/profiles/avatar-03.jpg" className=" img-fluid"/>
              </Link>
              <div className="mb-3">
                <p className="mb-0 text-dark fw-medium">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap shadow-sm noti-hover border p-3 pb-0 rounded mb-3">
            <div className="d-flex align-items-start flex-fill">
              <Link to="#" className="avatar avatar-lg flex-shrink-0 me-2 mb-3">
                <ImageWithBasePath alt="Lesley Grauer" src="assets/img/profiles/avatar-27.jpg" className=" img-fluid"/>
              </Link>
              <div className="mb-3">
                <p className="mb-0 text-dark  fw-medium">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap shadow-sm noti-hover border p-3 pb-0 rounded mb-3">
            <div className="d-flex align-items-start flex-fill">
              <Link to="#" className="avatar avatar-lg flex-shrink-0 me-2 mb-3">
                <ImageWithBasePath alt="Lesley Grauer" src="assets/img/profiles/avatar-10.jpg" className=" img-fluid"/>
              </Link>
              <div className="mb-3">
                <p className="mb-0 text-dark  fw-medium">
