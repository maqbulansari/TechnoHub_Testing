        ...
        <div className="col-xxl-6 col-xl-7 col-md-6">
          <div className="d-flex flex-column justify-content-between vh-100">
            ...
            <div className="d-flex flex-column justify-content-center align-items-center mb-4">
              <div className="mb-4">
                <ImageWithBasePath src="assets/img/authentication/error-404.svg" className="error-img img-fluid" alt="Img"/>
              </div>
              ...
              <Link to={routes.adminDashboard} className="btn btn-primary d-flex align-items-center">
