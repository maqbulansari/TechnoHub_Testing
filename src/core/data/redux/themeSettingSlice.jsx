...
const initialState = {
    ...
    dataSidebarBg: localStorage.getItem("dataSidebarBg") || "default_data_sidebar_bg",
...
export const { setDataLayout, resetAllMode, setTopBarColor, setDataTheme, setDataSidebar, setDataSidebarBg, setDataColor, setRtl, } = themeSettingSlice.actions;
