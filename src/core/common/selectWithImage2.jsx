...
export const SelectWithImage2 = () => {
    ...
    return (<div>
      <Dropdown value={selectedOption} options={options} optionLabel="label" optionValue="value" itemTemplate={customOptionTemplate} valueTemplate={customValueTemplate} onChange={(e) => setSelectedOption(e.value)} style={{ width: "100%" }} placeholder="Choose"/>
    </div>);
};
