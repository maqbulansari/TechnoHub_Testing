...
export const SelectWithImage = () => {
    ...
    const customOptionTemplate = (option) => (<div className="p-clearfix">
    ...
    return (<div>
      <Dropdown value={selectedOption} options={options} optionLabel="label" optionValue="value" itemTemplate={customOptionTemplate} valueTemplate={customValueTemplate} onChange={(e) => setSelectedOption(e.value)} style={{ width: "100%" }} placeholder="Choose Owner"/>
    </div>);
};
