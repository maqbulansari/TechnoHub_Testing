...
const AssessmentCandidateWithForm = () => {
    ...
    return (<div className="card m-4"><br />
      ...
      <div className="card-body">
        ...
        required: "Trainer Feedback is required.",
          ...
          <div className="col-xxl-6 col-xl-6 col-md-6">
            ...
            <select className={`form-select ${errors.assessment_test_status ? "is-invalid" : ""}`} {...register("assessment_test_status", {
          ...
          {role === "ADMIN" && (<>
            ...
            required: "Admin Feedback is required.",
              ...
              <div className="col-xxl-6 col-xl-6 col-md-6">
                ...
                <select className={`form-select ${errors.admin_selected ? "is-invalid" : ""}`} {...register("admin_selected", {
